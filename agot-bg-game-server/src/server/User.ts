...
export default class User {
    ...
    constructor(id: string, name: string, game: EntireGame, settings: UserSettings = {mapScrollbar: false, lastOpenedTab: null, chatHouseNames: false, responsiveLayout: false}, connected = false) {
        this.id = id;
        this.name = name;
