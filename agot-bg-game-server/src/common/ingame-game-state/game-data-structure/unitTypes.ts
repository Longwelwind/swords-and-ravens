...
export const siegeEngine = new UnitType("siege-engine", "Siege Engine", "Adds 4 Combat Strength when attacking (or supporting an attack against) an area containing a Castle or Stronghold, otherwise it adds 0. Siege Engines may not retreat when losing combat; it is destroyed instead. Costs 2 points of mustering (or 1 point if upgraded from a Footman).", RegionKind.LAND, 0, 4, null, false);
...
export const dragon = new UnitType("dragon", "Dragon", "Adds 0-5 Combat Strength in battle. Cannot be mustered.", RegionKind.LAND, 0);
