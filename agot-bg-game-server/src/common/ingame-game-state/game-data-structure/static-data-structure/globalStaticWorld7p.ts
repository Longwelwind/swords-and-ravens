...
const improvementSlotsLayer = westeros7pData.layers.find(l => l.name == "Improvement Slots");
if (!improvementSlotsLayer) {
    throw new Error("No layer named Improvement Slots in map file");
}

const castleSlotsLayer = westeros7pData.layers.find(l => l.name == "Castle Slots");
if (!castleSlotsLayer) {
