...
export default class App extends Component<AppProps> {
  ...
  get isConnected(): boolean {
    return (
      this.props.gameClient.connectionState == ConnectionState.SYNCED &&
  ...
  get is8pGame(): boolean {
    return (
      this.isGameRunning &&
      (this.entireGame?.gameSettings.playerCount ?? -1) >= 8
    );
  }

  render(): ReactNode {
    const minWidth =
      isMobile && this.isGameRunning
        ? this.is8pGame
          ? "2550px"
          : "2000px"
        : "auto";
      ...
      >
        <Row className="justify-content-center">
          {this.props.gameClient.isReconnecting ? (
            ...
            <Col xs="auto" className="m-4 p-3 text-center">
              <h4>
                <span className="loader">Connecting</span>
              </h4>
            </Col>
          ) : this.props.gameClient.connectionState ==
              ...
              <Col xs="auto" className="m-4 p-3 text-center">
                <Alert variant="danger">
                  ...
                  >
                    ...
                    <h5 className="ml-2 d-inline">Reload</h5>
                  </button>
                </Alert>
              </Col>
            </>
