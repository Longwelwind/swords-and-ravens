 ...
 */
const isWebSocket = (w: any): boolean => typeof w !== 'undefined' && !!w && w.CLOSING === 2;
...
export default class ReconnectingWebSocket {
    ...
    @observable isReconnecting: boolean;
    ...
    get maxRetries(): number {
        return this._options.maxRetries ? this._options.maxRetries : DEFAULT.maxRetries;
    }
    ...
    private _handleError = (event: Events.ErrorEvent): void => {
    ...
    private _handleClose = (event: Events.CloseEvent): void => {
