      ...
      <Row key={this.vote.id} className="flex-row">
        <Col xs={"auto"}>
          <OverlayTrigger
            placement="auto"
            overlay={
              <Tooltip id={"vote-date-" + this.vote.id}>
                {this.vote.createdAt.toLocaleString()}
              </Tooltip>
            }
          ...
          <Row className="mt-1">
            ...
            >
              <Button
                ...
                style={{ minWidth: "60px" }}
                disabled={disabled}
                onClick={() => this.vote.vote(true)}
              >
                {this.wrapVoteButtons(<>Accept</>, disabled, reason)}
              </Button>
              <br />
              <Button
                type="button"
                ...
                style={{ minWidth: "60px" }}
                disabled={disabled}
                onClick={() => this.vote.vote(false)}
              >
                {this.wrapVoteButtons(<>Refuse</>, disabled, reason)}
              </Button>
            </Col>
            <Col>
              <Row>
