...
export default class IngameComponent extends Component<IngameComponentProps> {
    ...
    render(): ReactNode {
        ...
        // This is a QnD fix. Todo: Investigate why the houses info column is stretched to about 500px in the live system
        const housesInfosMaxWidth = this.props.gameState.game.targaryen ? "none" : "460px";
        ...
        return (
            <>
                ...
                <Col xs={{ span: "auto", order: columnOrders.housesInfosColumn }} id="tracks-houses-column" style={{maxWidth: housesInfosMaxWidth}}>
