...
export default function setupAtWildlingAttackGameState(userSetupOptions: PartialRecursive<SetupOptions>): GlobalContext<BiddingGameState<WildlingsAttackGameState>> {
